/* plik: obliczeniaWentylatora.js */
/* autor: Grzegorz RUMATOWSKI */
/* obliczenia charakterystyk wedle schematu blokowego umieszczonego w pracy */ 
...
function obliczPunkty(dane)
{
    ...
    for (var i = 0; i < 5; i++)
	{
		...
		daneDoWykresu.mp[i] = ((daneDoWykresu.Q[i]*daneDoWykresu.deltap[i])/(daneDoWykresu.eta[i]*dane.etas))/100; 
        krok += 0.2;
    }
